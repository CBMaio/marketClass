        ...
        return (
            <div className="card overflow-hidden subscribe-widget p-3 mb-3 rounded-xxl border-0">
                <div className="card-body d-block text-left">
                    <h1 className="text-grey-800 font-xl fw-900 mb-4 lh-3">Suscríbete a nuestro boletín informativo</h1>
                    <form action="#" className="mt-3">
                        <div className="form-group icon-input">
                            <i className="ti-email text-grey-500 font-sm"></i>
                            <input type="text" className="form-control mb-2 bg-greylight border-0 style1-input pl-5" placeholder="Email" />
                        </div>
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" id="blankCheckbox" defaultValue="option1" />
                            <label className="text-grey-500 font-xssss" htmlFor="blankCheckbox">Acepto los términos y condiciones</label>
                        </div>
                    </form>
